...
const WatchLiveHighlightSection: React.FC = () => {
  const matchInfo = {
  ...
  return (
    <div
      ...
      style={{
        ...
        <SportsBanner slides={bannerSlides}/>
        <PopularTournaments/>
      ...
      {/*Eng vs Ind Highlights Section */}
<SeriesHighlight/>


      {/* Highlights by Sandbrix Section */}
     <HighlightsBySandbrix/>

   {/* Champions Waali Feeling Phir Se Section */}
   <ChampionsFeel/>

      {/* Popular Live Streaming Section */}
...
export default WatchLiveHighlightSection;
